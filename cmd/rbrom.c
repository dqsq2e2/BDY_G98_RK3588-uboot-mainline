...
U_BOOT_CMD(
	...
	"Reboot into Rockchip Maskrom download mode",
	"\n"
	"  - Writes BOOT_BROM_DOWNLOAD magic to boot mode register\n"
	"    and triggers a system reset to enter Maskrom mode.\n"
	"  - Supports RK3568 and RK3588 SOC_CON1 workaround."
);
